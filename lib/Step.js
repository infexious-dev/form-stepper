  ...
  _createClass(Step, [{
    ...
    value: function getStyles() {
      var _props = this.props,
          stepperBackground = _props.stepperBackground,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: styles.step, className: 'step ' + (active ? "active" : "") + ' ' + (completed ? "completed" : "") + ' ' + (disabled ? "disabled" : "") },
        _react2.default.createElement(
          'div',
          { style: circleStyle, className: 'step-circle-outer', onClick: onClick },
          active || completed ? _react2.default.createElement(
            'a',
            { href: href, style: styles.index, onClick: onClick, className: 'step-circle-inner' },
            stepContent
          ) : _react2.default.createElement(
            'span',
            { style: styles.index, className: 'step-circle-inner', onClick: onClick },
            stepContent
          )
        ),
        active || completed ? _react2.default.createElement(
          'a',
          { href: href, onClick: onClick, style: titleStyle, className: 'step-title' },
          title
        ) : _react2.default.createElement(
          'div',
          { style: titleStyle, onClick: onClick, className: 'step-title' },
          title
        ),
        !first && _react2.default.createElement('div', { style: leftStyle, className: 'step-bar left' }),
        !isLast && _react2.default.createElement('div', { style: rightStyle, className: 'step-bar right' })
      );
    }
  }]);
...
Step.propTypes = {
  stepperBackground: _propTypes.PropTypes.string,
